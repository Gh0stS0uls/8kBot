        ...
        {tab==="market" && (
          <div>
            ...
            <div style={{display:"flex",gap:8,marginBottom:10,alignItems:"center"}}>
              ...
              <img src={getPackImg(set.id)} alt={set.n} style={{width:50,height:70,borderRadius:4,border:`2px solid ${C.yellow}`,boxShadow:`0 3px 8px rgba(255, 203, 5, 0.25)`,objectFit:"contain",background:C.panel,padding:2}}/>
            </div>
